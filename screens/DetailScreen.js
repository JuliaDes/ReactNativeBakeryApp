...
<Title  style={styles.title2}>Mariage</Title>
    ...
    <Text style={styles.para}> Nous proposons une large gamme de pièces montées et wedding cakes, enrichie d’une offre de cocktails sucrés et salés pour accompagner tous les grands moments d’une vie</Text>
      ...
      <Text style={styles.para}>Gâteau ourson personnalisé, pièce montée Reine des Neiges ou un gâteau avec photo, il y en a pour tous les goûts !.</Text>
      <Image
    style={styles.img1}
    ...
    <Text style={styles.para}>Nous proposons de nombreux délicieux desserts pour célébrer un baptême ou une communion avec gourmandise ! La Romainville, </Text>
      </View>
      </ScrollView>
    </View>
        </PaperProvider>
